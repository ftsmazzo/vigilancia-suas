...
SELECT fam.d_cod_familiar_fam AS cod_familiar,
...
LEFT JOIN vw_pessoas_limpa rf
  ON rf.p_cod_familiar_fam = fam.d_cod_familiar_fam AND rf.p_cod_parentesco_rf_pessoa = 1
LEFT JOIN LATERAL (
...
LEFT JOIN mv_folha_familias fam ON fam.cod_familiar = b.cod_familiar
